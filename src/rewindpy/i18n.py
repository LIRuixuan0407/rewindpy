...
_MESSAGES: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "include_help": "Only trace files under this path (repeatable)",
        "exclude_help": "Exclude files under this path (repeatable)",
    ...
    "zh": {
        ...
        "open_help": "在浏览器中打开报告",
        "include_help": "仅追踪此路径下的文件（可重复使用）",
        "exclude_help": "排除此路径下的文件（可重复使用）",
